 ...
 *  读取缓存的频道列表
 */
- (NFChannels *)loadCanchedChannels;
 ...
 *
 */
- (NFNews *)loadCachedNewsWithChannel:(NFChannelInfo *)channel;
 ...
 *
 *  @discussion
 *  [必选]广告数据渲染完毕，即将展示时需调用本方法。
 *
 */
-(void)attachAd:(GDTNativeAdData *)nativeAdData;
 ...
 *
 */
- (BOOL)autoRefresh:(NSString *)channelId;
